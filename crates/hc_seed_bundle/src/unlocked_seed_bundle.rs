...
pub struct UnlockedSeedBundle {
    ...
    sign_pub_key: Arc<sodoken::LockedArray<{ sodoken::sign::PUBLICKEYBYTES }>>,
    sign_sec_key: Arc<Mutex<sodoken::LockedArray<{ sodoken::sign::SECRETKEYBYTES }>>>,
    app_data: Arc<[u8]>,
}
...
impl UnlockedSeedBundle {
    ...
    pub(crate) async fn priv_from_seed(
        mut seed: sodoken::LockedArray<32>,
    ) -> Result<Self, OneErr> {
        // generate the deterministic signature keypair represented by this seed
        let mut pk =
            sodoken::LockedArray::<{ sodoken::sign::PUBLICKEYBYTES }>::new()?;
        let mut sk =
            sodoken::LockedArray::<{ sodoken::sign::SECRETKEYBYTES }>::new()?;
    ...
    pub fn get_seed(&self) -> Arc<Mutex<sodoken::LockedArray<32>>> {
        self.seed.clone()
    }
    ...
    pub fn derive(
        ...
        async move {
            let mut new_seed = sodoken::LockedArray::new()?;
    ...
    pub fn get_sign_pub_key(
        &self,
    ) -> Arc<sodoken::LockedArray<{ sodoken::sign::PUBLICKEYBYTES }>> {
    ...
    pub fn sign_detached(
        ...
        Output = Result<
            sodoken::LockedArray<{ sodoken::sign::SIGNATUREBYTES }>,
            OneErr,
        >,
    >
           + 'static
           + Send
    {
        ...
        async move {
            let mut sig =
                sodoken::LockedArray::<{ sodoken::sign::SIGNATUREBYTES }>::new(
                )?;
            sodoken::sign::sign_detached(&mut sig.lock(), &message, &sign_sec_key.lock().lock())?;
            Ok(sig)
        }
    }
