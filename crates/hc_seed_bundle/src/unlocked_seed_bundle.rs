...
pub struct UnlockedSeedBundle {
    ...
    sign_pub_key: Arc<
        Mutex<sodoken::SizedLockedArray<{ sodoken::sign::PUBLICKEYBYTES }>>,
    >,
    sign_sec_key: Arc<
        Mutex<sodoken::SizedLockedArray<{ sodoken::sign::SECRETKEYBYTES }>>,
    >,
    app_data: Arc<[u8]>,
}
...
impl UnlockedSeedBundle {
    ...
    pub fn get_seed(&self) -> Arc<Mutex<sodoken::SizedLockedArray<32>>> {
        self.seed.clone()
    }
    ...
    pub fn get_sign_pub_key(
        &self,
    ) -> Arc<Mutex<sodoken::SizedLockedArray<{ sodoken::sign::PUBLICKEYBYTES }>>>
    {
