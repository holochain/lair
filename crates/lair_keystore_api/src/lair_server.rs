...
//     use crate::mem_store::create_mem_store_factory;

//     use super::*;

//     // #[tokio::test]
//     async fn deep_seed_roundtrip() {
//         let factory = create_mem_store_factory();
//         let passphrase = BufReadSized::from([1; 64]);
//         let config = Arc::new(
...
//         let wrong_passphrase = BufReadSized::from([2; 64]);
...
//         {
//             let tag = Arc::from("tag");
//             srv.priv_get_full_entry_by_tag(&srv.0, tag)
//         };
//         let tag = Arc::from("tag");
//         let entry = store.get_entry_by_tag(tag).await.unwrap();
//         entry.entry
//     }
// }
